/**
 * @fileoverview plugin for iungo products
 * @author ledamint
 */
'use strict';
...
module.exports = {
    meta: {
        ...
        docs: {
            url: 'https://github.com/iungopbx/iungo-javascript#specify-todo--fixme-comment-with-jira-or-another-bug-tracking-system-task-id-or-username'
        }
    },
    create(context) {
        return {
